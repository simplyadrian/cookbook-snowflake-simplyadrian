...
* `snowflake-nativex::set_datacenterid_and_workerid`:
...
<table>
  ...
  <tr>
    ...
    <td><tt>[{:name => 'twitter-scala-parent-overrides',
            ...
            {:name => 'snowflake',
              :url => 'https://s3-us-west-2.amazonaws.com/archive-code-nativex/snowflake.tgz'}]</tt></td>
  </tr>
  <tr>
    <td><tt>['snowflake-nativex']['install_method']</tt></td>
    <td>String</td>
  ...
  <tr>
    <td><tt>['snowflake-nativex']['zookeeper']['host_list']</tt></td>
    <td>String</td>
...
<table>
  ...
  <tr>
    <td><tt>['snowflake-nativex']['java']['main_jar']</tt></td>
    <td>String</td>
    <td>The snowflake project main jar file.</td>
    <td><tt>snowflake-1.0.1-SNAPSHOT.jar</tt></td>
  </tr>
  <tr>
    <td><tt>['snowflake-nativex']['java']['main_class']</tt></td>
    <td>String</td>
  ...
  <tr>
    <td><tt>['snowflake-nativex']['java']['gc_opts']</tt></td>
    <td>String</td>
