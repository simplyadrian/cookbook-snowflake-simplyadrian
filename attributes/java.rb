...
default['snowflake-nativex']['java']['main_class'] = 'com.twitter.service.snowflake.SnowflakeServer'
...
default['snowflake-nativex']['java']['gc_opts'] = '-XX:+UseConcMarkSweepGC -verbosegc -XX:+PrintGCDetails -XX:+PrintGCTimeStamps -XX:+PrintGCDateStamps -XX:+UseParNewGC -Xloggc:/var/log/snowflake_gc.log'
# Java debug options for the snow application.
default['snowflake-nativex']['java']['debug_opts'] = '-XX:ErrorFile=/var/log/$APP_NAME_java_error%p.log'
